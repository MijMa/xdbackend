...
Local; with running frontend and backend via host computer command console and local database and supertokens docker container instances
containerized local: with all parts of the system running on the development computer using containers via docker-compose
containerized remote: with all parts of the system running on the remote server using containers via docker-compose
